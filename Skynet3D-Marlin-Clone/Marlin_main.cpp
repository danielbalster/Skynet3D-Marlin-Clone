 ...
 *
 * ************* dbalster hacks **********
 * M333 will measure the bed using an inductive sensor
 *
 ...
 * - then move to -X until inductive sensor will trigger
 * - same for +X, -Y and +Y
 * extends and offsets will be reported :-)
 * 
 */
...
void process_next_command() {
  ...
  switch (command_code) {
    ...
    case 'M': switch (codenum) {
      ...
      case 333: // M333: auto bed measure
        gcode_M333();
        break;
